...
Min 8 chars and Max 12 chars"/>
        ...
        <div class="img-registro res">
            <img class="side res <?php echo htmlspecialchars($style_err2); ?>" src="/img/alt/side-registro-<?php echo rand(1, 9); ?>.png" alt="Registro" />
        </div>
...
Min 8 chars and Max 12 chars"/>
        ...
        <div class="img-registro noRes">
            <img src="side-registro-<?php echo rand(1, 13); ?>.png" alt="Registro" width="700px" />
        </div>
    </body>
