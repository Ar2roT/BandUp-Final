...
<body class="">
            ...
            <nav >
                ...
                <input type="checkbox" id="menu-toggle" />
                    <ul id="trickMenu">
                        ...
                        <li><a href="https://bandup.monkeydevs.mx/quienes-somos.html">QUIÉNES SOMOS</a></li>
    ...
    <nav id="navReg" class="nav-reg">
        <ul class="menu">
            <ul class="menu">
            <li class="mayus paddI"><label for="menu-toggleC" style="text-transform: uppercase;">
                <svg class="usuario-reg" viewBox="0 0 20 20" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.773.813c4.971 0 9 3.827 9 8.55 0 4.722-4.029 8.55-9 8.55-4.97 0-9-3.828-9-8.55 0-4.723 4.03-8.55 9-8.55zm.787 11.257H8.975c-1.964.004-3.554 1.515-3.558 3.38h0v.388l-.03-.018a8.311 8.311 0 004.385 1.236 8.27 8.27 0 004.345-1.212h0v-.394c-.003-1.865-1.594-3.376-3.557-3.38h0zM9.778 1.668h-.022c-4.47 0-8.094 3.442-8.094 7.689 0 2.348 1.108 4.451 2.868 5.86.14-2.219 2.076-3.977 4.445-3.98h1.584c2.37.003 4.305 1.762 4.457 3.982 1.747-1.41 2.856-3.514 2.856-5.862 0-4.247-3.623-7.69-8.094-7.69h0zm-.005 1.71c1.989 0 3.6 1.53 3.6 3.42 0 1.889-1.611 3.42-3.6 3.42-1.988 0-3.6-1.531-3.6-3.42 0-1.89 1.612-3.42 3.6-3.42zm0 .855c-1.49.003-2.696 1.15-2.7 2.565 0 1.416 1.21 2.565 2.7 2.565 1.491 0 2.7-1.149 2.7-2.565 0-1.417-1.209-2.565-2.7-2.565h0z" fill="#282d35" fill-rule="nonzero" stroke="#282d35" stroke-width=".25"> 
                </path>
                </svg>
                <?php echo htmlspecialchars($str_bienvenida); ?>
                <input type="checkbox" id="menu-toggleC" />
                <?php 
                    if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {
                ?>
                        <ul id="cuentaMenu">
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;" href="login.php">No has iniciado sesión. <br><b>> Inicia sesión para continuar.</b></a></li>
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;"><b>> Activar modo oscuro.</b></a></li>
                        </ul>
                    </li>
                <?
                    } else {
                ?>
                        <ul id="cuentaMenu" style="margin: 10px -85px;">
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;" href="reset-password.php">> Cambiar contraseña.</a></li>
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;" id="dark">> Activar modo oscuro.</a></li>
                            <br>
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;" href="admin/product-edit.php">> Editar productos.</a></li>
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;" href="admin/product-insert.php">> Insertar productos.</a></li>
                            <br>
                            <li><a class="iniciar-sesion" style="text-transform: initial; text-align: right;" href="logout.php"><b>> Cerrar sesión.</b></a></li>
                        </ul>
                <?  
                    }
                ?>
            ...
            <label class="" for="menu-toggle4">
                ...
                ?>
                        <ul id="carritoMenu" class="items">
                            ...
                            <li><a href="/checkout.php"><b>></b> Ver carrito</a></li>
                            <?php }else{ ?>
